...
class Microdot:
    ...
    async def start_server(self, host="0.0.0.0", port=5000, debug=False, ssl=None, start_serving=True):
        ...
        try:
            self.server = await asyncio.start_server(serve, host, port, ssl=ssl, start_serving=start_serving)
